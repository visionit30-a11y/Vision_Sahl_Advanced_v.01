...
class Permission(StrEnum):
    ...
    TENANT_WORKFLOW_REQUESTS_CREATE = "tenant.workflow_requests.create"
    TENANT_WORKFLOW_REQUESTS_READ = "tenant.workflow_requests.read"
    TENANT_WORKFLOW_APPROVALS_DECIDE = "tenant.workflow_approvals.decide"
